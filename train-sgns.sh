...
case $1 in 
        hyper1)  for i in {0..9}; do do_hyper $i; done 
                ;;
        hyper2)  for i in {0..9}; do do_hyper_random $i; done 
                ;;
        word2vec)  for i in {0..9}; do do_word2vec $i; done 
                ;;
        gensim1)  for i in {0..9}; do do_gensim_default $i; done 
                ;;
        gensim2)  for i in {0..9}; do do_gensim_deterministic $i; done 
                ;;
        gensim3)  for i in {0..9}; do do_gensim_random $i; done 
                ;;
